...
2. For `TO_NUMBER`, this needs to be the phone number you used to verify your Twilio account. On the free trial versions we are playing with, **we can only send SMS to this number** (or other numbers that you specifically [verify](https://support.twilio.com/hc/en-us/articles/223180048-Adding-a-Verified-Phone-Number-or-Caller-ID-with-Twilio) and add to the account). This should be in the same format as the new Twilio phone number: +15555555555 for example. Twilio just needs [this formatting, called e.164](https://www.twilio.com/docs/glossary/what-e164).
